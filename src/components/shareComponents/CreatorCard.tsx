...
const CreatorCard: React.FC<creatorCardProps> = ({ username }) => {
    return (
        <div className="w-[400px] max-sm:w-[400px] min-[959px]:w-full aspect-square xl:aspect-4/3 rounded-2xl border border-slate-300 relative hover:shadow-custom2 duration-500">
            ...
            <div className="absolute -mr-[50%] left-2/4 -translate-x-1/2 -translate-y-1/2 top-[calc(50%+24px)] xl:top-[calc(50%+32px)]">
                <div className="profile_image max-sm:w-32 w-2/4 sm:w-4/5 lg:w-24 2xl:w-32 mx-auto aspect-square bg-slate-500 outline outline-8 outline-white"></div>
